import {validateLoginAction, validatePasswordAction, validateProfileAction, errorSubmitAction} from '../actions/actionCreator';
...
export default class SignupApi {
        ...
        return dispatch => {
            ...
            if(_login && _password && _passwordConfirmation && _url && _error) {
                ...
                .catch(error => {
                    ...
                    dispatch(errorSubmitAction(finalError));
                    setTimeout(() => { 
                        finalError = '';
    ...
    static compareLoginWithPassword(loginValue, Password, Confirmation) {
        let passwordConflict = 'A senha não pode ser igual ao login!'; // eslint-disable-next-line
        finalError;
